...
def add_projects(apps, schema_editor):
    path = '/home/vlad/Documents/python/django_tm/tm/dashboard/migrations/data/projects.csv'
...
def add_issues(apps, schema_editor):
    path = '/home/vlad/Documents/python/django_tm/tm/dashboard/migrations/data/issues.csv'
    with open(path) as file:
        reader = csv.DictReader(file, delimiter=',')
        for line in reader:
